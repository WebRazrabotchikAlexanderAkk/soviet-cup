...
<ul
	...
	if ( $wishlist && $wishlist->has_items() ) :
					...
					<div class="additional-info-wrapper">
						...
						<?php if ( $show_remove_product || $repeat_remove_button ) : ?>
							<div class="product-remove">
								<a href="<?php echo esc_url( $item->get_remove_url() ); ?>" class="remove_from_wishlist" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Убрать из избранного', 'yith-woocommerce-wishlist' ) ) ); ?>"><svg class="inline-svg-icon" width="13" height="13">
		...
		<p class="wishlist-empty">
			<?php echo esc_html( apply_filters( 'yith_wcwl_no_product_to_remove_message', __( 'Здесь ничего нет. Ваш список избранного пуст', 'yith-woocommerce-wishlist' ) ) ); ?>
		</p>
	<?php endif; ?>
