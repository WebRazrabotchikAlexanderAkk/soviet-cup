		...
		<div class="catalog__container">
			...
			<span class="catalog__quantity-products">
				...
				<div class="catalog__filter">
							...
							<!-- Сортировать списком -->
							<div class="catalog__filter_item">
								<button type="button" class="catalog__button btn_list active" aria-label="Сортировать списком">
									<svg class="inline-svg-icon" width="20" height="20">
				...
				<div class="catalog__wrapper">						
					...
					<div class="catalog__body">
						<div class="catalog__product product catalog__product_list">					
							<!-- Продукт карточка 2 -->
							<?php require_once 'product-2.php'; ?>
